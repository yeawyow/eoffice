        ...
        var t = $('#example').DataTable({
            ...
            "columnDefs": [

                {
                    "targets": -1,
                    "data": null,
                    "defaultContent": " <button  id='edit' class='btn btn-primary'>แก้ไข</button>   <button id='delete' class='btn btn-danger' >ลบ</button>  <button id='delete' class='btn btn-warning' >สิทธ์กลุ่ม</button>",
                    'bSortable': false
                },
