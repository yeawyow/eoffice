        ...
        function(date, format, language){
          ...
          if (dspThaiYear(language)){
            var formats = format //this.parseFormat(format)
              ...
              , trnfrm  = {
                  yy  : (date.getUTCFullYear()).toString().substring(2) /* ให้ใส่ฟอแมตเป็น en เป็น 2016-01-01 ถ้าต้องการใส่ลงใน input เป็นวันที่ไทยให้เพิ่ม this.adj+ นำหน้า*/
                , yyyy: (date.getUTCFullYear()).toString() /* ให้ใส่ฟอแมตเป็น en เป็น 2016-01-01 ถ้าต้องการใส่ลงใน input เป็นวันที่ไทยให้เพิ่ม this.adj+ นำหน้า*/
                }
